    ...
    <div class="container">
        ...
        <div class="generator">
            <div class="generator__form">
                <form method="post" action="<?= base_url('/modeles/' . e($template['slug']) . '/generer') ?>" data-generator-form data-doc-slug="<?= e($template['slug']) ?>" data-invoice-form>
                    <?= csrf_field() ?>
                    ...
                    <h3 style="margin-top:var(--sp-5)">Produits / prestations</h3>
                    <div data-invoice-items></div>
                    <button type="button" class="btn btn-secondary btn-sm" data-add-item style="margin-top:var(--sp-2)">+ Ajouter une ligne</button>

                    <div class="hero__ctas mt-6">
